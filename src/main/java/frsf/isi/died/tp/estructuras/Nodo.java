 ...
 * @param unNodo si cumple con alguna condicion
 */
...
System.out.print("No se puede agregar como hijo");	
	...
	if (this.tipoNodo==TipoDeDato.TITULO && (unNodo.tipoNodo==TipoDeDato.METADATO || unNodo.tipoNodo==TipoDeDato.RESUMEN || unNodo.tipoNodo==TipoDeDato.CAPITULO)) {
this.hijos.add(unNodo);	
}
else {
	if (this.tipoNodo==TipoDeDato.METADATO && (unNodo.tipoNodo==TipoDeDato.AUTOR || unNodo.tipoNodo==TipoDeDato.EDITORIAL || unNodo.tipoNodo==TipoDeDato.PALABRA_CLAVE || unNodo.tipoNodo==TipoDeDato.FECHA_PUBLICACION)) {
this.hijos.add(unNodo);		
	}
